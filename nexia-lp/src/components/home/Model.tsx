      ...
      <div className="mx-auto max-w-6xl">
        ...
        <ScrollReveal delay={100}>
          <div className="mx-auto flex max-w-3xl flex-wrap items-center justify-center gap-3 text-center">
            <div className="rounded-3xl border-2 border-brand/30 bg-brand-soft px-6 py-5">
            ...
            <div className="rounded-3xl border-2 border-coral/30 bg-coral-soft px-6 py-5">
              <p className="text-xs font-bold text-coral">既存の仕組み</p>
              <p className="mt-1 text-xl font-extrabold text-ink">子ども食堂</p>
            </div>
            <span className="text-3xl font-extrabold text-ink-3">=</span>
            <div className="rounded-3xl bg-ink px-6 py-5 text-white shadow-xl">
