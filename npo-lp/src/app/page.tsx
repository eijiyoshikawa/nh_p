        ...
        <Reveal>
          <section className="px-4 py-12 sm:px-6">
            <div className="mx-auto grid max-w-4xl gap-4 sm:grid-cols-2">
              <a
                href="/grants"
                className="hover-lift group rounded-2xl border-2 border-emerald-100 bg-white p-6 shadow-sm transition-all hover:border-accent-green"
              >
              ...
              <a
                href="/glossary"
                className="hover-lift group rounded-2xl border-2 border-emerald-100 bg-white p-6 shadow-sm transition-all hover:border-accent-green sm:col-span-2"
              >
                <p className="text-2xl">📖</p>
                <h3 className="mt-2 text-base font-bold text-text-primary group-hover:text-accent-green">
                  用語集
