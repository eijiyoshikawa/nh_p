        ...
        <section className="px-4 py-12 sm:px-6">
          <div className="mx-auto grid max-w-4xl gap-4 sm:grid-cols-2">
            ...
            >
              ...
              <span className="mt-3 inline-block text-sm font-medium text-accent-orange">
                リストを見る →
              </span>
            </a>
            <a
            ...
            <a
              href="/glossary"
              className="group rounded-2xl border-2 border-green-200 bg-white p-6 shadow-sm transition-all hover:border-accent-green hover:shadow-md sm:col-span-2"
            >
              <p className="text-2xl">📖</p>
