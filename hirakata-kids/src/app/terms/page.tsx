  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <section className="mt-8 space-y-4 text-sm leading-7 text-stone-700">
        <p>
          この利用規約（以下「本規約」といいます）は、{site.operator.name}（以下「当法人」といいます）が運営する
      ...
      <section className="mt-8">
        ...
        <p className="mt-3 text-sm leading-7 text-stone-700">
          本規約は、利用者と当法人との間の本サイトの利用に関わる一切の関係に適用されます。
        </p>
      </section>
      ...
      <section className="mt-8">
        ...
        <p className="mt-3 text-sm leading-7 text-stone-700">
          本サイトに掲載されているテキスト、画像、デザイン等の著作権は、当法人または正当な権利者に帰属します。私的使用の範囲を超える利用（無断転載、改変、再配布等）は禁じます。
        </p>
        <p className="mt-3 text-sm leading-7 text-stone-700">
      ...
      <section className="mt-8">
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-7 text-stone-700">
          ...
          <li>犯罪行為に関連する行為</li>
          <li>当法人、他の利用者、または第三者の知的財産権、プライバシー、名誉その他の権利を侵害する行為</li>
      ...
      <section className="mt-8">
        ...
        <p className="mt-3 text-sm leading-7 text-stone-700">
          本サイトの情報を利用することで生じた損害について、当法人は一切の責任を負いません。施設の営業時間・料金・サービス内容等は変更される場合がありますので、ご来訪前に各施設の公式情報をご確認ください。
        </p>
        <p className="mt-3 text-sm leading-7 text-stone-700">
          本サイトからリンクする外部サイトの内容については、当法人は責任を負いません。
        </p>
      </section>
      ...
      <section className="mt-8">
        ...
        <p className="mt-3 text-sm leading-7 text-stone-700">
          当法人が第三者から対価を得て掲載する記事には、記事冒頭に「PR」「広告」等の表記を行います。アフィリエイトリンクを含む記事にも同様の表示を行います。
        </p>
      </section>
      ...
      <section className="mt-8">
        ...
        <p className="mt-3 text-sm leading-7 text-stone-700">
          当法人は、必要と判断した場合、利用者への事前通知なく本規約を変更できるものとします。変更後の本規約は、本サイトに掲載された時点から効力を生じるものとします。
        </p>
      </section>
